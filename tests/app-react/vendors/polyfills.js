...
if (!String.prototype.padEnd) {
	String.prototype.padEnd = function padEnd(tLen, padString) {
		let targetLength;
		targetLength = tLen >> 0; //floor if number or convert non-number to 0;
		padString = String((typeof padString !== 'undefined' ? padString : ' '));
		if (this.length > targetLength) {
			return String(this);
		} else {
			targetLength = tLen - this.length;
...
const s = Object.prototype.toString.call(main);
